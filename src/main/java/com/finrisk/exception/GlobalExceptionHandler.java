...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<String>> handledValidation(MethodArgumentNotValidException ex, HttpServletRequest request) {
    ...
    public ResponseEntity<ApiResponse<String>> handledNotFound(ResourceNotFound ex, HttpServletRequest request) {
        ApiResponse<String> response = new ApiResponse<>();
        response.setSuccess(false);
